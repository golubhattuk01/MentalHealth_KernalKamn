  ...
  return (
    ...
    >
      <div className="text-center text-purple-800">
        ...
        <p className="text-lg md:text-xl ml-30 mr-30 text-gray-700 mb-6 font-serif">
          We have designed a solution for mental health which Focuses on <br />
          providing information about mental health and benefits of the website.<br />
    ...
    >
      <div className="text-center text-purple-800">
        ...
        <p className="text-lg md:text-xl ml-30 mr-30 text-gray-700 mb-6 font-serif">
        Engage and educate through interactive mental health quizzes that will <br />
        help you initialize what you need to recover and is beneficial to heal.
        </p>
        <button className="mt-4 mr-4 bg-gradient-to-b from-purple-600 to-purple-800 px-4 py-2 text-white uppercase rounded text-xs tracking-wider">
          Get Started
        </button>
      </div>
    </div>
