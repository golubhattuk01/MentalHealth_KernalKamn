...
const Footer = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-purple-400 to-purple-200  py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-800">
      <div className="ml-7">
        <h1 className="w-full text-3xl font-bold text-purple-800">
          KernalKaam
        </h1>
        <p className="py-4 text-gray-800 space-x-4">
          Remember, healing is not a linear journey. Be patient with yourself.
          Reach out for support when you need it, and always remember that you
          are not alone on this path to wellness
        </p>
      ...
      <div className="lg:col-span-2 flex justify-between mt-6 w-40 ml-auto ">
        <div>
          ...
          <ul>
            ...
            {firebase.user && <li onClick={firebase.logout}>Log Out</li>}
          </ul>
        </div>
      </div>
    </div>
