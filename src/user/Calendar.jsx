...
const Calendar = () => {
  ...
  const renderCalendarGrid = () => {
    ...
    for (let i = 0; i < 30; i++) {
      grid.push(
        <div
          key={i}
          className="date-cell rounded-md border-blue-500 hover:bg-purple-800 hover:text-white"
  ...
  return (
    <div className="calendar-container bg-gradient-to-b from-purple-200 to-purple-400 ">
